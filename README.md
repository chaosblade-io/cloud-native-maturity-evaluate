...
<p align="center">
  <img src="docs/images/architecture.png" alt="SESORA 架构图" width="800">
</p>
...
<p align="center">
  <img src="docs/images/web-dashboard.png" alt="Web 管理界面" width="800">
</p>
...
| 文件 | 用途 |
|------|------|
| [pyproject.toml](pyproject.toml) | 现代 Python 包配置（推荐） |
| [requirements.txt](requirements.txt) | 传统依赖列表（兼容） |
